...
EOF;
    ...
    protected function execute($arguments = array(), $options = array())
    {
        ...
        if (!in_array(strtolower($options['orm']), array('doctrine', 'propel', 'none'))) {
        ...
        } elseif ('Propel' === $options['orm']) {
            include sfConfig::get('sf_root_dir') . '/plugins/sf' . $options['orm'] . 'ORMPlugin/config/installer.php';
        }
